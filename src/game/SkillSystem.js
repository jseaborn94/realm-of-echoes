  ...
  warrior: [
    {
      ...
      icon: '⚔️',
      key: 'Q',
      description: 'Swift melee strike in front.',
      manaCost: 0,
      cooldown: 0.5,
      castType: 'instant_melee',
      range: 50,
      damageScaling: { attack: 1.2 },
      areaRadius: 0,
    },
    {
      id: 'cleave',
      ...
      castType: 'instant_melee',
      range: 60,
      damageScaling: { attack: 1.0, level: 0.3 },
      areaRadius: 45,
    },
    {
      id: 'shield_bash',
      ...
      icon: '🛡️',
      key: 'E',
      description: 'Stun nearby enemies. Requires shield.',
      manaCost: 35,
      cooldown: 5.0,
    ...
    },
    {
      ...
      icon: '💨',
      key: 'R',
      description: 'Spin, hitting all nearby enemies.',
      manaCost: 60,
      cooldown: 20.0,
      castType: 'ground_target_aoe',
      range: 100,
  ...
  archer: [
    {
      ...
      icon: '🏹',
      key: 'Q',
      description: 'Fire arrow at distant target.',
      manaCost: 0,
      cooldown: 0.6,
      castType: 'projectile',
      range: 240,
      damageScaling: { attack: 1.1 },
      projectileSpeed: 300,
      areaRadius: 0,
    },
    {
      ...
      castType: 'projectile',
      range: 240,
      damageScaling: { attack: 0.8, level: 0.2 },
      projectileSpeed: 280,
      areaRadius: 0,
    },
    {
    ...
    },
    {
      ...
      icon: '🌧️',
      key: 'R',
      description: 'Massive barrage over wide area.',
      manaCost: 70,
      cooldown: 25.0,
      castType: 'ground_target_aoe',
      range: 220,
  ...
  lancer: [
    {
      ...
      icon: '🗡️',
      key: 'Q',
      description: 'Fast thrust forward.',
      manaCost: 0,
      cooldown: 0.5,
      castType: 'instant_melee',
      range: 62,
      damageScaling: { attack: 1.3 },
      areaRadius: 0,
    },
    {
      id: 'charge',
      ...
      icon: '💨',
      key: 'W',
      description: 'Dash forward, damaging on contact.',
      manaCost: 25,
      cooldown: 3.5,
      castType: 'dash',
      range: 120,
      damageScaling: { attack: 1.0, level: 0.2 },
      areaRadius: 40,
    },
    {
      id: 'pierce',
      ...
      icon: '⚡',
      key: 'E',
      description: 'Piercing strike hitting all in line.',
      manaCost: 35,
      cooldown: 4.5,
      castType: 'ground_target_aoe',
      range: 80,
      damageScaling: { attack: 1.2, level: 0.25 },
      areaRadius: 30,
    },
    {
      id: 'spear_storm',
      ...
      icon: '🌪️',
      key: 'R',
      description: 'Unleash spear barrage.',
      manaCost: 65,
      cooldown: 22.0,
      castType: 'ground_target_aoe',
      range: 160,
  ...
  monk: [
    {
      ...
      icon: '👊',
      key: 'Q',
      description: 'Quick unarmed strike.',
      manaCost: 0,
      cooldown: 0.4,
      castType: 'instant_melee',
      range: 40,
      damageScaling: { attack: 1.1, level: 0.1 },
      areaRadius: 0,
    },
    {
      id: 'chi_burst',
      ...
      icon: '✨',
      key: 'W',
      description: 'Release chi energy in pulse.',
      manaCost: 30,
      cooldown: 3.0,
      castType: 'ground_target_aoe',
      range: 100,
      damageScaling: { attack: 0.6, level: 0.3 },
      areaRadius: 50,
    },
    {
      id: 'meditate',
      ...
      icon: '🧘',
      key: 'E',
      description: 'Restore health and mana over time.',
      manaCost: 20,
      cooldown: 8.0,
      castType: 'self_buff',
      range: 0,
      damageScaling: { level: 0.5 },
      duration: 3.0,
    },
    {
      id: 'enlightenment',
      ...
      icon: '🌟',
      key: 'R',
      description: 'Enhanced chi—boost damage and speed.',
      manaCost: 55,
      cooldown: 18.0,
      castType: 'self_buff',
      range: 0,
