/**
 * QuestSystem.js — Data-driven quest definitions
 * All quests are defined here; state is managed by QuestManager
 */
...
/**
 * Get all quests for a given quest giver
 */
export function getQuestsByGiver(giverName) {
  return Object.values(QUESTS).filter(q => q.questGiver === giverName);
}
